...
namespace MaratonaXamarin.AndroidApp
{
    ...
    public class MainActivity : Activity
    {
        protected override void OnCreate(Bundle bundle)
        {
            ...
            var button = FindViewById<Button>(Resource.Id.btnCarregar);
            var listView = FindViewById<ListView>(Resource.Id.lvwItens);
            ...
            button.Click += async (sender, e) =>
            {
                ...
                listView.Adapter = new ArrayAdapter(this, Android.Resource.Layout.SimpleListItemSingleChoice,
                    users.OrderBy(u => u.Name).Select(u => $"{u.Id} {u.Name}").ToArray());
            };
        }
    }
}
